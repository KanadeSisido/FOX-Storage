...
export function Sidebar({ currentFolderId, folders = [], onFolderCreated }: SidebarProps) {
  return (
      ...
      <div className="p-4">
        ...
        <ScrollArea className="h-[calc(100vh-8rem)]">
          <div className="space-y-2">
            <Button variant={!currentFolderId ? "secondary" : "ghost"} className="w-full justify-start" asChild>
              <Link href="/dashboard">
